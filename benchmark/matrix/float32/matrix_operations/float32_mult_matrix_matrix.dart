// Approx. 5.5 seconds (MacBook Pro 2019), Dart version: 2.16.0
// Approx. 8.0 seconds (MacBook Air mid 2017), Dart version: 2.16.0
...
class Float32MatrixMultMatrixMatrixBenchmark extends BenchmarkBase {
  ...
  final Matrix other =
      Matrix.random(numOfColumns, numOfRows, dtype: DType.float32, seed: 5);
