...
void vectorSumTestGroupFactory(DType dtype) =>
    group(dtypeToVectorTestTitle[dtype], () {
      group('sum method', () {
        ...
        test('should find vector elements sum, negative and positive numbers '
            'case', () {
          final vector = Vector.fromList([1.0, -20.0, 3.02, 14.0, -5.0],
              dtype: dtype);

          expect(vector.sum(), closeTo(-6.98, 1e-3));
        });

        test('should find vector elements sum if the vector consists of just '
            'only element', () {
        ...
        test('should return zero if the vector consists of just '
            'only zero', () {
        ...
        test('should find vector elements sum if there are zeroes in the '
            'vector', () {
