  ...
  group('Vector', () {
    group('float32', () {
      test('should create vector instance via `fromList` constructor', () {
        expect(Vector.fromList([1, 2, 3], dtype: DType.float32),
            isA<Float32x4Vector>());
        expect(Vector.fromList([1, 2, 3], dtype: DType.float32),
            hasLength(3));
      });
      ...
      test('should create vector instance via `zero` constructor', () {
        expect(Vector.zero(5, dtype: DType.float32), isA<Float32x4Vector>());
        expect(Vector.zero(5, dtype: DType.float32), hasLength(5));
      });
      ...
      test('should create vector instance via `filled` constructor', () {
        expect(Vector.filled(7, 3, dtype: DType.float32),
            isA<Float32x4Vector>());
        expect(Vector.filled(7, 3, dtype: DType.float32),
            hasLength(7));
      });
      ...
      test('should create vector instance via `randomFilled` constructor', () {
        expect(Vector.randomFilled(11, dtype: DType.float32),
            isA<Float32x4Vector>());
        expect(Vector.randomFilled(11, dtype: DType.float32),
            hasLength(11));
      });
