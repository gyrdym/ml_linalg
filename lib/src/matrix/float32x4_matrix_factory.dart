...
abstract class Float32x4MatrixFactory {
  ...
  static MLMatrix<Float32x4, MLVector<Float32x4>> rows(List<MLVector<Float32x4>> source) =>
      Float32x4Matrix.rows(source);

  static MLMatrix<Float32x4, MLVector<Float32x4>> columns(List<MLVector<Float32x4>> source) =>
