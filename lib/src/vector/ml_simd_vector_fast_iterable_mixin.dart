...
abstract class MLSimdVectorFastIterableMixin<E, S extends List<E>> implements
    MLVectorFactory<E, S>, MLVectorDataStore<E, S>, MLSimdOperationsHelper<E, S>, MLVector {

  @override
  MLVector fastMap<T>(T mapper(T element, int offsetStartIdx, int offsetEndIdx)) {
    ...
    for (int i = 0; i < data.length; i++) {
      ...
      list[i] = mapper(data[i] as T, offsetStart, math.min(offsetEnd, length - 1));
    }
