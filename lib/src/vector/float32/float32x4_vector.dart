...
class Float32x4VectorInternal extends Object with
  ...
  Float32x4VectorInternal.fromSIMDList(Float32x4List source, {int origLength, this.isMutable = false}) {
  ...
  Float32x4VectorInternal.filled(int length, double value, {this.isMutable = false}) {
    this.length = length;
  ...
  Float32x4VectorInternal.zero(int length, {this.isMutable = false}) {
    this.length = length;
  ...
  Float32x4VectorInternal.randomFilled(int length, {int seed, this.isMutable = false}) {
    this.length = length;
